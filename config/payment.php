...
if(env('APP_DEBUG') == true){
    $gmo_api_url = 'https://pt01.mul-pay.jp/payment/';
    $gmo_js_url = 'https://stg.static.mul-pay.jp/ext/js/token.js';
} else{
    $gmo_api_url = 'https://p01.mul-pay.jp/payment/';
    $gmo_js_url = 'https://static.mul-pay.jp/ext/js/token.js';
}
return [
    'gmo_site_id' => env('GMO_SITE_ID'),
    'gmo_site_pass' => env('GMO_SITE_PASSWORD'),
    'gmo_shop_id' => env('GMO_SHOP_ID'),
    'gmo_shop_pass' => env('GMO_SHOP_PASSWORD'),

    'gmo_js_url' => $gmo_js_url,

    'entry_tran_url' =>     $gmo_api_url . 'EntryTran.idPass',
    'exec_tran_url' =>      $gmo_api_url . 'ExecTran.idPass',
    'alter_tran_url' =>     $gmo_api_url . 'AlterTran.idPass',
    'secure_tran_url' =>    $gmo_api_url . 'SecureTran.idPass',
    'change_tran_rul' =>    $gmo_api_url . 'ChangeTran.idPass',
    'save_card_url' =>      $gmo_api_url . 'SaveCard.idPass',
    'delete_card_url' =>    $gmo_api_url . 'DeleteCard.idPass',
    'search_card_url' =>    $gmo_api_url . 'SearchCard.idPass',
    'traded_card_url' =>    $gmo_api_url . 'TradedCard.idPass',
    'save_member_url' =>    $gmo_api_url . 'SaveMember.idPass',
    'delete_member_url' =>  $gmo_api_url . 'DeleteMember.idPass',
    'search_member_url' =>  $gmo_api_url . 'SearchMember.idPass',
    'update_member_url' =>  $gmo_api_url . 'UpdateMember.idPass',
    'search_trade_url ' =>  $gmo_api_url . 'SearchTrade.idPass',

    'token_success_code' => '000',
