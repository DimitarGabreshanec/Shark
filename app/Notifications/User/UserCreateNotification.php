...
class UserCreateNotification extends Notification
{
    ...
    public function toMail($notifiable)
    {
        ...
        return (new MailMessage)
            ->subject(Lang::get('message.Mail.UserCreated.Title'))
            ->line(Lang::get('message.Mail.UserCreated.Line1'))
            ->line(Lang::get('message.Mail.UserCreated.Line2'))
            ->line($this->p_email)
            ->line(Lang::get('message.Mail.UserCreated.Line3'))
