...
@section('content')
    <main>
        <div class="gray-contents">
            ...
            <p class="mb20">商品やサービス決済用のクレジットカード情報を入力してください。</p>
            ...
            <input type="checkbox" name="save_card" id="save_card"><label for="save_card">このカードの情報を保存して、次回も使用する</label>
            <input type="submit" id="btn_purchase" name="use_new_card" value="支払う">
            <input type="submit" id="btn_to_back" value="戻る">
...
@section('page_js')
    ...
    <script>
        $(document).ready(function(e) {
            ...
            $("#btn_to_back").bind("click", function (e) {
                e.preventDefault();
                location.href = "{{ route('user.order.credit_card',['order_type' => $order_type]) }}";
            });
        });
